...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/idormenco/JohnnyCash>";
    const std::string URL_WEBSITE = "<https://github.com/idormenco/JohnnyCash>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("johnnycash version %s\n", FormatFullVersion());
}
