...
#if defined(NDEBUG)
# error "johnnycash cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "johnnycash Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s JCC additional fees, %d delta bytes\n",
