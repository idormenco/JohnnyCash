...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s johnnycash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  johnnycash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded johnnycash transaction") + "\n" +
              "  johnnycash-tx [options] -create [commands]   " + _("Create hex-encoded johnnycash transaction") + "\n" +
              "\n";
