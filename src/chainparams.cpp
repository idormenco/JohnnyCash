...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("seed-a.johnnycash.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.johnnycashtools.com", true);
        //vSeeds.emplace_back("dnsseed.johnnycashpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.johnnycashtools.com", true);
        vSeeds.emplace_back("seed-b.johnnycash.loshan.co.uk", true);
