...
* Update manpages, see [gen-manpages.sh](https://github.com/idormenco/JohnnyCash/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [johnnycash-detached-sigs](https://github.com/idormenco/JohnnyCash-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/idormenco/JohnnyCash/releases/new) with a link to the archived release notes.
